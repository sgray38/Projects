...
from keras.layers import Input, Conv2D, Flatten, Dense, concatenate, Add
...
HEIGHT_MULTIPLIER = -5
ROW_INCENTIVE_MULTIPLIER = 0.2
BUMPINESS_PENALTY = -10
FLATNESS_REWARD = 0.5
GAME_OVER_REWARD = -50
HOLE_PENALTY = -5  # You can adjust this weight as needed
...
class DQNAgent:
    ...
    def act(self, state):
        ...
        q_values = self.model.predict([board_state, piece_info], verbose=0)
...
# agent = DQNAgent(starting_epsilon=0.29, model='tetris_models/model.keras')
...
for episode in range(episode_override, EPISODES):
